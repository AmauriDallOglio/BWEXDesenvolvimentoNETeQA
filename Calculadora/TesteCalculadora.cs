using BWEXDesenvolvimentoNETeQA.Entidades;

namespace Calculadora
{
    public class TesteCalculadora
    {
        private readonly CalculadoraFator _calculadora;
        public TesteCalculadora()
        {
            _calculadora = new CalculadoraFator();
        }
        ...
        {
            CalculadoraFator novaCalculadora = new CalculadoraFator();
